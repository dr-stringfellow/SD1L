...
def dijetfit(options):
    ...
    for i, nPars in enumerate(nParsToTry):
        ...
        #rescale so pdfs are in evts per 20 GeV
        ...
        maximum = fit_hist.GetMaximum()
        minimum = fit_hist.GetMinimum()
        ...
        PlotFitResults(frame, fres.GetName(), nPars, hresid_norm, data_name,
                       ...
                       plot_dir, plot_label = label, maxy=float(maximum), miny=float(minimum))
...
def fitting_options():
    ...
    parser.add_option("--nbinsx", type=int, default=25,
                      help="Nbinsx")
    ...
    parser.add_option("-i", "--inputFile", dest="inputFile",
                      ...
                      help="input h5 file")
    parser.add_option("-p", "--plotDir", dest="plotDir", default='/eos/user/b/bmaier/www/figs/l1ds/fits/',
